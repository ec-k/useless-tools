...
// All rights reserved.
//
// This code is governed by a BSD-style license that can be found in the LICENSE file
// of the discordgo repository (at https://github.com/bwmarrin/discordgo/blob/master/LICENSE).
//
// This code is adapted from an example found in the discordgo repository:
// https://github.com/bwmarrin/discordgo/blob/master/examples/echo/main.go
